...

{
    ...
    Info << "tan(beta) = " << Foam::tan(beta_) << endl;
}
...
bool Foam::RBFMotionFunctionObject::execute()
{
    ...
    Info << "old time: "      << oldTime 		<< endl;
    Info << "current time: "  << curTime 		<< endl;
    Info << "aoa old: "       << aoaOld 		<< endl;
    Info << "aoa current: "   << aoaCur 		<< endl;
    Info << "alpha old: "     << alphaOld 		<< endl;
    Info << "xdot current: "  << xdotCur 		<< endl;
    Info << "xdot old: "      << xdotOld 		<< endl;
    Info << "alpha current: " << alphaCur 		<< endl;
    Info << "translation x: " << translationVector[0] 	<< endl;
    Info << "translation y: " << translationVector[1] 	<< endl;
    ms.setMotion(motion);
